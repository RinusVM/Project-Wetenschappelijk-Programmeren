...
barcode1 = barcodelezer.extraheerBarcode("projectWetProg/fotos/foto1.jpg")
barcode2 = barcodelezer.extraheerBarcode("projectWetProg/fotos/foto2.jpg")
barcode3 = barcodelezer.extraheerBarcode("projectWetProg/fotos/foto3.jpg")
barcodetest = barcodelezer.extraheerBarcode("projectWetProg/fotos/fototest.jpg")
...
prijstest = berekenPrijs(IDtest)

prijstotaal = prijs1 + prijs2 + prijs3
print("De totaalprijs is", prijstotaal)
print("De prijs van de test foto is", prijstest)
